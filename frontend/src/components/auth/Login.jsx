...
import img from "../../assests/icons8-batman-logo-1600-removebg-preview.png"
const Login = () => {
        ...
        <div class="w-full">
          <form class="shadow-md rounded px-8 pt-6 pb-8 mb-4" >
            ...
            <div class="flex items-center justify-center">
              <button onClick={handleSubmit} class="bg-[#b3ccdb] hover:bg-[#07091d] hover:text-[#b3ccdb] text-[#0f111f] font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline flex flex-row" type="button">
